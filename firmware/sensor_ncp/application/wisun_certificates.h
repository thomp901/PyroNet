/*
 * Local Wi-SUN credentials for the PyroNet border router.
 *
 * These are intentionally kept in-repo so this project can build against the
 * local certificate set instead of the SDK demo bundle.
 */
