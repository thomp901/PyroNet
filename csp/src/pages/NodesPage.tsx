...
export function NodesPage() {
  ...
  const sortedNodes = [...data].sort(sortNodes);
    ...
    <PageContainer>
      <div className="card">
        <TableShell
          ...
          columns={["Node", "Location", "Risk", "Temp", "RH", "VOC", "PM2.5", "Battery %", "Last Seen"]}
          headerCells={[
            {
              key: "node",
        ...
        >
          {sortedNodes.map((node) => (
            <tr
              ...
              onClick={() => openNodeDetail(node.nodeId)}
            ...
            >
              ...
              <td>
                {formatNullableNumber(node.latestTelemetry?.temperatureC ?? null, "°C")}
              </td>
